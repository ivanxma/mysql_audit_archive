...
"    query VARCHAR(4096) PATH '$.general_data.query', " 
...
if mystart > 0 :
  ...
  if osarg == 2 :
    ...
    if mymethod == "dump" :
      ...
      util.export_table("audit_archive." + dumptablename, tbname + ".csv",  {"osBucketName": mybucket, "osNamespace": mynamespace,"dialect":"csv"})
